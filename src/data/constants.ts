...
export const EXPERIENCE: Experience[] = [
  {
    ...
    endDate: "Present",
    title: "AI/ML Member",
    company: "SRM INSIDER & Team Envision — SRMIST",
    description: [
      "Active member of two AI/ML clubs at SRM Institute of Science and Technology.",
      "Working on LLM-assisted blast-induced slope failure (BSF) prediction using the Konkan Railway dataset.",
      "Collaborating with Foresight Research Group to develop predictive models from real-world blasting parameters during railway slope excavation.",
  ...
  },
  {
    ...
    description: [
      ...
      "Fast-moving HealthTech startup under the mentorship of SRM Development and Innovation Hub.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.FASTAPI,
